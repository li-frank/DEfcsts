DROP TABLE p_csi_tbs_t.fl_DEvert_actuals;

CREATE MULTISET TABLE p_csi_tbs_t.fl_DEvert_actuals
AS
(SELECT
...
--                      ON SLR_RR.CURNCY_ID = SPR.CURNCY_ID
            ...
            WHERE 1=1
                        AND GEM.CK_DATE >= '2010-01-01' 
                        AND GEM.CK_DATE <= '2013-12-31' 
                        AND GEM.LSTG_END_DT >= '2010-01-01'
...
) WITH DATA PRIMARY INDEX (ckDate, VERTICAL);
