SELECT
            ...
            CAL.MONTH_BEG_DT,
            CAL.MONTH_OF_YEAR_ID AS CAL_MON,
            ...
            CASE GEM.LSTG_SITE_ID
                        WHEN 77 THEN 'eBay.de'
                        ELSE 'Other'
            END AS LSTG_SITE,
            ...
            CASE COND.CNDTN_ROLLUP_ID
                        WHEN 1 THEN 'New'
                        WHEN 2 THEN 'Refurbished'
                        WHEN 3 THEN 'Used'
--                      WHEN 4 THEN 'Not Spcfd'
                        ELSE 'Other'
            END AS ITEM_COND,
            
            CASE 
                        WHEN GEM.LSTG_TYPE_CODE IN (7,9) THEN 'Fixed Price'
                        ELSE 'Auction'
            END AS LSTG_TYPE,
...
--                      ON SLR_RR.CURNCY_ID = SPR.CURNCY_ID
            ...
            WHERE 1=1
                        AND GEM.CK_DATE BETWEEN '2012-01-01' AND '2013-12-28'
                        AND GEM.LSTG_END_DT >= '2012-01-01'
